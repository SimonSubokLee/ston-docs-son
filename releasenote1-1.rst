...
**버그수정**
 ...
 - DIMS변환 중 Hardpurge API를 호출 할 경우 간헐적으로 비정상 종료되던 증상
...
----------------------------
   ...
   - **FileSystem 업그레이드**
     ...
     | :ref:`id3`, XML/JSON, :ref:`cache`, 상세통계 가 추가 되었습니다.
...
**버그수정**
   ...
   - 극히 드물게 잘못된 문자열 참조 오류로 인해 비정상 종료되던 증상
...
----------------------------
   ...
   - STON이 서비스를 감당할 수 없는 상태에 :ref:`emergency`로 전환됩니다.
...
**기능개선/정책변경**
   ...
   - OriginOptions의 일부설정(:ref:`user-agent`, :ref:`host`, WL-Proxy-Client-IP, :ref:`xff-x-forwarded-for`)을 바이패스되는 HTTP요청에 선택적으로 적용할 수 있습니다.

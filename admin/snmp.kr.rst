...
-  ``[diskIndex]``
   ...
   For example, the OID that refers to the entire volume of /cache1 is system.diskInfo.diskInfoTotalSize.1(1.3.6.1.4.1.40001.1.2.18.1.3.1) and the last .1 refers to the first disk.
